 ...
 */
public class buscar_especie extends javax.swing.JFrame {

    
    public buscar_especie(int codplant) {
        initComponents();
        Menu.bt_buscaenfermedad.setEnabled(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tabla.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar una especie.", "Especie", JOptionPane.ERROR_MESSAGE);

        } else {
            Menu.text_especie.setText(tabla.getValueAt(tabla.getSelectedRow(), 1).toString());
            Menu.codespecie=Integer.parseInt(tabla.getValueAt(tabla.getSelectedRow(), 0).toString());
            Menu.bt_buscaenfermedad.setEnabled(true);
            Menu.text_enfermedad.setText("");
            Menu.codenf=0;
            dispose();
        }
