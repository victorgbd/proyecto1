...
public class buscar_vehiculo extends javax.swing.JFrame {
    ...
    private void llenarTabla(String dato) {
        ...
        modelo.setColumnIdentifiers(new Object[]{
            "Codigo de Vehículo", "Tipo","Matrícula"
        });
        String sql = "select v.codvehiculo,tv.descripcion,v.matricula from vehiculo as v "
                + "INNER JOIN tipo_de_vehiculo as tv on v.tipovehiculo=tv.codtipvehiculo WHERE v.disponibilidad = 0 and ("
                + "tv.descripcion LIKE  '%" + dato + "%'"
                + "OR v.codvehiculo LIKE  '%" + dato + "%'"
                + "OR v.matricula LIKE  '%" + dato + "%')";
        ResultSet rs = Funciones.consulta(sql);
        try {
            while (rs.next()) {
                // agrega los datos de la consulta al modelo de la tabla
                modelo.addRow(new Object[]{
                    rs.getString("codvehiculo"),
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo Vehiculo", "Tipo", "Matricula"
            }
        ) {
