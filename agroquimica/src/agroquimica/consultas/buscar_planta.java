 ...
 */
public class buscar_planta extends javax.swing.JFrame {

    public buscar_planta() {
        initComponents();
        Menu.bt_buscaespecie.setEnabled(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tabla.getSelectedRow() < 0) {
            ...
            Menu.text_planta.setText(tabla.getValueAt(tabla.getSelectedRow(), 1).toString());
            Menu.codplant = Integer.parseInt(tabla.getValueAt(tabla.getSelectedRow(), 0).toString());
            Menu.bt_buscaespecie.setEnabled(true);
            Menu.text_enfermedad.setText("");
            Menu.codenf = 0;
            Menu.text_especie.setText("");
            Menu.codespecie = 0;
            dispose();
        }
